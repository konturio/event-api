...
class HistoricalTornadoJapanMaImportJobIT extends AbstractCleanableIntegrationTest {

    private final HistoricalTornadoJapanMaImportJob job;
    ...
    @MockBean
    private HistoricalTornadoJapanMaHtmlParser parser;
    ...
    @Test
    public void testHistoricalTornadoJapanMaImportJobRun() throws IOException {
