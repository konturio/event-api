...
public final class NhcUtil {
    ...
    public static final String MAIN_REGEXP = "(.*) (TROPICAL DEPRESSION|SUBTROPICAL DEPRESSION|TROPICAL STORM|HURRICANE \\(TYPHOON\\)|HURRICANE|SUBTROPICAL STORM|POST-TROPICAL CYCLONE \\/ REMNANTS|POST-TROPICAL CYCLONE|POTENTIAL TROPICAL CYCLONE) (.*)(?=(FORECAST\\/ADVISORY))FORECAST\\/ADVISORY NUMBER ([0-9]{1,}).*(AL|EP[0-9]{6}) ([0-9]{4} \\w{3} \\w{3} \\w{3} [0-9]{2} [0-9]{4}) (.*) (TROPICAL DEPRESSION|SUBTROPICAL DEPRESSION|TROPICAL STORM|HURRICANE \\(TYPHOON\\)|HURRICANE|SUBTROPICAL STORM|POST-TROPICAL CYCLONE \\/ REMNANTS|POST-TROPICAL CYCLONE|POTENTIAL TROPICAL CYCLONE) (CENTER LOCATED NEAR .*) (MAX SUSTAINED WINDS.*) (REPEAT.*?)( FORECAST VALID .*?)?( EXTENDED OUTLOOK.*?)?( OUTLOOK VALID .*?)?( REQUEST .*)";
    ...
    public static final Integer CURRENT_TIME_POS = 7;
    public static final Integer NEWS_POS = 8;
    public static final Integer CENTER_POS = 10;
    public static final Integer MAX_SUSTAINED_WIND_POS = 11;
    public static final Integer FORECAST_POS = 13;
    public static final Integer OUTLOOK_POS = 15;
