...
public final class NhcUtil {
    ...
    public static final String MAIN_REGEXP = "(.*?)(TROPICAL DEPRESSION|SUBTROPICAL DEPRESSION|TROPICAL STORM|HURRICANE \\(TYPHOON\\)|HURRICANE|SUBTROPICAL STORM|POST-TROPICAL CYCLONE \\/ REMNANTS|POST-TROPICAL CYCLONE|POTENTIAL TROPICAL CYCLONE|TROPICAL CYCLONE|POTENTIAL TROP CYCLONE|REMNANTS)( OF )?(.*?)?(?=(FORECAST\\/ADVISORY))FORECAST\\/ADVISORY NUMBER ([0-9]{1,}).*((AL[0-9]{6})|([EC]P[0-9]{6}))(.*?)?([0-9]{4} \\w{3} \\w{3} \\w{3} [0-9]{2} [0-9]{4})(.*)?(TROPICAL DEPRESSION|SUBTROPICAL DEPRESSION|TROPICAL STORM|HURRICANE \\(TYPHOON\\)|HURRICANE|SUBTROPICAL STORM|POST-TROPICAL CYCLONE \\/ REMNANTS|POST-TROPICAL CYCLONE|POTENTIAL TROPICAL CYCLONE|TROPICAL CYCLONE|POTENTIAL TROP CYCLONE|REMNANTS)( OF )?(.*)?(CENTER LOCATED NEAR .*)(MAX SUSTAINED WINDS.*)(REPEAT.*?)( FORECAST VALID .*?)?( EXTENDED OUTLOOK.*?)?( OUTLOOK VALID .*?)?( REQUEST.*)";
