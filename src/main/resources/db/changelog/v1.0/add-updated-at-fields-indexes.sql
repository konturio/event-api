...
--changeset event-api-migrations:v1.0/add-updated-at-fields-indexes.sql runOnChange:true
...
create index if not exists feed_event_status_recombined_at_idx
    on feed_event_status (recombined_at);
