...
--changeset event-api-migrations:v1.10/update-severity-values-for-latest-event-versions-2021-07-01.sql runOnChange:false
...
with events as (
    ...
    from feed_data
    where is_latest_version and updated_at >= '2021-04-01' and updated_at < '2021-07-01'
)
update feed_data fd
set
