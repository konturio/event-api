...
--changeset event-api-migrations:v1.10/update-severity-values-for-latest-event-versions-2022-04-01.sql runOnChange:false
...
with events as (
    ...
    from feed_data
    where is_latest_version and updated_at >= '2022-01-01' and updated_at < '2022-04-01'
)
update feed_data fd
set
